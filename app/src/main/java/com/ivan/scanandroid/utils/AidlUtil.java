package com.ivan.scanandroid.utils;
...
import com.ivan.scanandroid.R;
import com.ivan.scanandroid.bean.TableItem;
...
public class AidlUtil {
     ...
     * 打印文字
     */
    public void printText(String content, float size, boolean isBold, boolean isUnderLine,boolean isCenter) {
        if (woyouService == null) {
            Toast.makeText(context,R.string.toast_2, Toast.LENGTH_LONG).show();
            return;
        }
